...
public class Conecta4V2 {
    ...
    public static void main(String[] args) {
        ...
        do {
            if (iniciar == 1) {
                System.out.println("Es el turno de " + jugador1.toUpperCase() + ", tu símbolo es la X.");
            } else if (iniciar == 2) {
                System.out.println("Es el turno de " + jugador2.toUpperCase() + ", tu símbolo es la O.");
            }

            mostrarTablero(conecta, filas, columnas);

            tirada(conecta, iniciar, filas, columnas);

            ganador = conecta4(conecta, iniciar, filas, columnas);
    ...
    private static void mostrarTablero(int[][] conecta, int filas, int columnas) {
    ...
    private static void tirada(int[][] conecta, int iniciar, int filas, int columnas) {
        Scanner sc = new Scanner(System.in);
    ...
    private static Boolean conecta4(int[][] conecta, int iniciar, int filas, int columnas) {
    ...
    private static void winner(int iniciar, String jugador1, String jugador2) {
        if (iniciar == 1) {
            System.out.println("Ha gando el jugador: " + jugador1);
        } else {
